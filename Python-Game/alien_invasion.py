...
class AlienInvasion:
    ...
    def _fire_bullet(self):
        ...
        if len(self.bullets) < self.settings.bullets_allowed:
            ...
            self.bullets.add(new_bullet) #add similar to append
    ...
    def _update_aliens(self):
        ...
        """Checking if the fleet is at an edge,
            then update the pos of aliens in the fleet"""
    ...
    def _create_fleet(self):
        ...
        #determing number of rows of aliens that'll fit on screen
    ...
    def _change_fleet_direction(self):
        ...
        self.settings.fleet_direction *= -1 #make direction negative to change direction

    def _ship_hit(self):
        """responding to ship getting hit by alien"""
